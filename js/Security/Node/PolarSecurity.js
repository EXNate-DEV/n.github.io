...
* @returns {Uint8Array}
*/
module.exports.file_decode = function(file) {
    try {
...
* @returns {Uint8Array}
*/
module.exports.file_encode = function(file) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passArray8ToWasm0(file, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.file_encode(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v1 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);
...
const path = require('path').join(__dirname, 'PolarSecurity_bg.wasm');
