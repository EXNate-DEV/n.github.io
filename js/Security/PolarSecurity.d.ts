...
* @returns {Uint8Array}
*/
export function file_decode(file: Uint8Array): Uint8Array;
/**
* @param {Uint8Array} file
* @returns {Uint8Array}
*/
export function file_encode(file: Uint8Array): Uint8Array;
/**
...
export interface InitOutput {
  ...
  readonly file_decode: (a: number, b: number, c: number) => void;
  readonly file_encode: (a: number, b: number, c: number) => void;
